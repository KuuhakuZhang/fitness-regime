...
const workoutPlans = [
  ...
  },
  {
    ...
    short: "爆",
    name: "爆发力训练",
    subtitle: "健身房器械版：足球启动、变向与攀岩动态发力",
    duration: 70,
    sections: [
      { title: "跑步机热身与激活", items: [
        ["跑步机快走 / 慢跑", "8 分钟"],
        ["弹力带侧向走", "2 × 12 / 侧"],
        ["绳索面拉轻重量", "2 × 15"]
      ]},
  ...
  },
  {
    ...
    short: "耐",
    name: "耐力训练",
    subtitle: "健身房器械版：跑步机坡度、楼梯机与上肢耐力",
    duration: 80,
    sections: [
      { title: "热身与呼吸节奏", items: [
        ["跑步机轻松慢跑 / 快走", "8–10 分钟"],
  ...
  },
  {
    ...
    short: "衡",
    name: "平衡性训练",
    subtitle: "健身房器械版：足踝稳定、单腿控制与核心抗旋转",
    duration: 50,
    sections: [
      { title: "足踝与核心激活", items: [
        ["跑步机坡度快走", "6 分钟"],
        ["髋外展弹力带侧走", "3 × 12 / 侧"],
        ["绳索 Pallof Press", "3 × 10 / 侧"]
      ]},
      { title: "平衡主项", items: [
        ["哑铃单腿罗马尼亚硬拉", "3 × 10 / 侧"],
        ["史密斯机保加利亚分腿蹲", "3 × 10 / 侧"],
  ...
  },
  {
    ...
    short: "柔",
    name: "柔韧性训练",
    subtitle: "健身房器械版：髋、踝、胸椎与肩背活动度恢复",
    duration: 45,
    sections: [
      { title: "呼吸与放松", items: [
        ["拉伸垫 90/90 呼吸", "3 分钟"],
  ...
  },
  {
    ...
    short: "趣",
    name: "自由活动日",
    subtitle: "健身房课程、泳池或低强度有氧",
    duration: 60,
    activities: ["健身房团课", "游泳池游泳", "水中行走", "跑步机爬坡", "楼梯机", "椭圆机恢复"]
  }
];

const cardioChoices = ["跑步机爬坡", "游泳", "水中行走", "椭圆机", "楼梯机", "划船机"];
const trainingTypes = [
  ["strength", "力量训练"],
  ["power", "爆发力训练"],
  ["endurance", "耐力训练"],
